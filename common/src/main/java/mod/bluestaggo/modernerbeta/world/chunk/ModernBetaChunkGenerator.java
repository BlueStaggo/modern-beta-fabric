...
public class ModernBetaChunkGenerator extends NoiseChunkGenerator {
    ...
    public static final DeferredRegister<Codec<? extends ChunkGenerator>> CHUNK_GENERATOR = DeferredRegister.create(ModernerBeta.MOD_ID, RegistryKeys.CHUNK_GENERATOR);
    ...
    public void carve(ChunkRegion chunkRegion, long seed, NoiseConfig noiseConfig, BiomeAccess biomeAccess, StructureAccessor structureAccessor, Chunk chunk, GenerationStep.Carver carverStep) {
        ...
        Registry<ConfiguredCarver<?>> configuredCarverRegistry = chunkRegion.getRegistryManager().get(RegistryKeys.CONFIGURED_CARVER);
